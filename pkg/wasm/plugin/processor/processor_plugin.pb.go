...
//export processors_api_version
func _processors_api_version() uint64 {
	return ProcessorsPluginAPIVersion
}
...
//export processors_process
func _processors_process(ptr, size uint32) uint64 {
