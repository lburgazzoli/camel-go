...
type IntegrationInformer interface {
	...
	Lister() v2alpha1.IntegrationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CamelV2alpha1().Integrations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CamelV2alpha1().Integrations(namespace).Watch(context.TODO(), options)
			},
		},
		&camelv2alpha1.Integration{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *integrationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&camelv2alpha1.Integration{}, f.defaultInformer)
}

func (f *integrationInformer) Lister() v2alpha1.IntegrationLister {
	return v2alpha1.NewIntegrationLister(f.Informer().GetIndexer())
}
